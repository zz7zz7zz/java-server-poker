...
public final class BaseGameCmd {
	...
	public static final int CMD_CLIENT_USER_EXIT             	= 0x1001;//用户退出
	public static final int CMD_CLIENT_USER_READY 				= 0x1002;//用户准备
	public static final int CMD_CLIENT_KICK_USER 	    		= 0x1003;//用户踢人
	public static final int CMD_CLIENT_OFFLINE 	    			= 0x1004;//用户掉线
