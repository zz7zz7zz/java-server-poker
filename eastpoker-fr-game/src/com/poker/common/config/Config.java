...
public class Config {
    ...
    protected void initFileConfig(HashMap<String,Object> map){
    	if(null !=map){
    		...
    		table_count = CfgParser.getInt(map, "Room","table_count");
    		table_min_user = CfgParser.getInt(map, "Room","table_min_user");
    		table_max_user = CfgParser.getInt(map, "Room","table_max_user");
    		table_init_chip = CfgParser.getInt(map, "Room","table_init_chip");
    		table_init_ante = CfgParser.getInt(map, "Room","table_init_ante");
    		
        String val[]     = CfgParser.getStringArray(map,"Room","table_bilnd");
        if(null != val){
        ...
        val    = CfgParser.getStringArray(map,"Room","table_bilnd_time");
        if(null != val){
    		...
    		table_action_timeout = CfgParser.getInt(map, "Room","table_action_timeout");
	...
	public String toString() {
		return "Config [game_id=" + game_id + ", dispatcher_net_tcp=" + Arrays.toString(dispatcher_net_tcp)
				...
				+ Arrays.toString(monitor_net_udp) + ", table_count=" + table_count + ", table_min_user="
				+ table_min_user + ", table_max_user=" + table_max_user + ", table_init_chip=" + table_init_chip
				+ ", table_bilnd=" + Arrays.toString(table_bilnd) + ", table_bilnd_time="
				+ Arrays.toString(table_bilnd_time) + ", table_action_timeout=" + table_action_timeout + "]";
	}
