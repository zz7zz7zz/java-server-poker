...
public final class TexasCmd {
	...
	public static final int CMD_SERVER_BROADCAST_USER_ACTION 		= 0x2007; //广播 谁做了什么操作,下一个操作者是谁
	public static final int CMD_SERVER_BROADCAST_NEXT_OPERATE 		= 0x2008; //广播 谁做了什么操作,下一个操作者是谁
	public static final int CMD_SERVER_BROADCAST_SHOW_HAND 			= 0x2009; //广播 秀牌

	public static final int CMD_SERVER_RECONNECT 	    			= 0x200A; //客户端请求重连
	public static final int CMD_SERVER_GAME_END 	    			= 0x200B; //游戏结束，进行结算
}
